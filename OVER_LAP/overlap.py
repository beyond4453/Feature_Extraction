...
fin_1 = open('answer_content_pro.txt','r')
fin_2 = open('question_content_pro.txt','r')
fin_3 = open('user_interest_pro.txt')

fout_1 = open('q_a_overlap.txt','w')
fout_2 = open('q_u_overlap.txt','w')
fout_3 = open('a_u_overlap.txt','w')
